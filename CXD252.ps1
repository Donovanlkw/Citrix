...
Set-AzureRmVMCustomScriptExtension -ResourceGroupName $rgname -VMName $VMName -Name VDAInstallnExtension -FileUri "https://cxd251impdata.blob.core.windows.net/vda/InstallVDA_v1912.ps1" -Run 'InstallVDA_v1912.ps1' -Location "East US 2"
Remove-AzureRmVMExtension -ResourceGroupName $rgname -VMName $VMName -Name "VDAInstallnExtension" -Force
